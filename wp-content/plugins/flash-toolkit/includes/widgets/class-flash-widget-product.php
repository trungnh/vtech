 ...
 */
class FT_Widget_Product extends FT_Widget {
    ...
    public function __construct() {
        ...
        $this->widget_description = __( 'Add your product here.', 'flash-toolkit' );
        $this->widget_id          = 'themegrill_flash_portfolio';
        $this->widget_name        = __( 'FT: Product', 'flash-toolkit' );
    ...
    public function widget( $args, $instance ) {
        ...
        flash_get_template( 'content-widget-product.php', array( 'instance' => $instance ) );
